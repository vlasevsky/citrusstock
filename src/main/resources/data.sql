...
-- Insert a sample product batch (using product id=1 and supplier id=1)
INSERT INTO product_batches (product_id, supplier_id, total_boxes, received_at, status)
VALUES (1, 1, 3, CURRENT_TIMESTAMP, 'WAITING_FOR_SCANNING');

-- Insert sample boxes for the product batch with id=1
INSERT INTO boxes (code, product_batch_id, status) VALUES
                                                       ('boxCode1', 1, 'GENERATED'),
                                                       ('boxCode2', 1, 'GENERATED'),
                                                       ('boxCode3', 1, 'GENERATED');

-- Insert sample users
INSERT INTO users (username, password, role)
VALUES ('manager', 'password', 'WAREHOUSE_MANAGER'), ('operator1', 'password', 'OPERATOR');
